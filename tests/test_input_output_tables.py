...
class TestLoadingCSVIOTable:
    ...
    def test_1841_io_table_meta_data(self, io_1841_table) -> None:
        ...
        assert io_1841_table._raw_io_table__meta_data.name == io_table_1841.NAME
        assert io_1841_table._raw_io_table__meta_data.year == io_table_1841.YEAR
        assert io_1841_table._raw_io_table__meta_data.region == io_table_1841.REGION
        assert io_1841_table._raw_io_table__meta_data.authors == io_table_1841.AUTHORS
        assert io_1841_table._raw_io_table__meta_data.doi == io_table_1841.DOI
        assert (
            io_1841_table._raw_io_table__meta_data.url
