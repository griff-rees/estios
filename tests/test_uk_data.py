...
class TestGDPProjections:
    ...
    CORRECT_2021_CONV_RATE: Series = Series(
        ...
        {2017: 1941090.1347361521, 2020: 1797290.6241410251, 2025: 2139685.974804}
    )
    CORRECT_2010_CONV_RATE: Series = Series(
        ...
        {2017: 2014587.6332391994, 2020: 1865343.2934083908, 2025: 2220703.112502}
    )

    # Last set 2023-03-16
    CONV_RATE_2021: float = 0.676658
    CONV_RATE_2010: float = 0.702279
